<script context="module">
    export function generateCardTransform(rotZ = 0, rotY = 0) {
...
<style lang="scss">
    @keyframes throw-left-animation {
        to {
            transform: translate(-101vw, -101vh) rotateZ(1800deg)
    ...
    .card {
        ...
        transform: translate(-50%, -50%) rotateZ(var(--card-rotate-z, 0deg))
            rotateY(var(--card-rotate-y, 0deg));
